...
//			String imgpath = fLib.getFilePathFromPropertiesFile("imgfilepath");
	...
	//}
	   ...
	   /*public void fileuploadbasedonid(WebDriver driver, String id,String imgpath)
	   {
		   File f=new File(imgpath);
			String ap = f.getAbsolutePath();
			driver.findElement(By.id(id)).sendKeys(ap);
			
	   }
	   public void fileuploadbasedonname(WebDriver driver, String name)
	   {
		   File f1=new File(imgpath);
			String ap1 = f1.getAbsolutePath();
			driver.findElement(By.name(name)).sendKeys(ap1);
